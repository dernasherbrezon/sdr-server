...
void test_max_input_buffer_size() {
  ...
  const float expected[] = {0.0008628f, 0.0008561f, -0.0003212f, -0.0018911f, 0.0005033f, 0.0077399f, -0.0025557f, -0.0186932f, 0.0062834f, 0.0407742f, -0.0307208f, -0.1272911f, 0.0272516f, -0.1294039f, -0.0046343f, 0.0409085f, 0.0021694f, -0.0183142f, -0.0008918f, 0.0078921f, 0.0002496f,
                            ...
                            -0.0009243f, -0.0017916f, 0.0007080f, 0.0019446f, 0.0016318f, -0.0070375f, -0.0011612f, 0.0209157f, 0.0022075f, -0.0471232f, 0.0226710f, 0.1932120f, -0.0339800f, 0.0320866f, 0.0204571f, 0.0564104f, -0.0631220f, -0.2452638f, 0.0600419f, -0.2621585f, -0.0107641f,
                            0.0833772f};
...
void test_parital_input_buffer_size() {
  ...
  size_t output_len = 0;
  process(input, input_len, &output, &output_len, filter);
  const float expected[] = {0.0008628f, 0.0008561f, -0.0003212f, -0.0018911f, 0.0005033f, 0.0077399f, -0.0025557f, -0.0186932f, 0.0062834f, 0.0407742f, -0.0307208f, -0.1272911f, 0.0272516f, -0.1294039f, -0.0046343f, 0.0409085f, 0.0021694f, -0.0183142f, -0.0009561f, 0.0061021f, 0.0009056f,
                            0.0001416f, 0.0008022f, -0.0062015f, -0.0028520f, 0.0192238f, 0.0028523f, -0.0398353f, 0.0208307f, 0.1720470f, -0.0310534f, 0.0843434f, 0.0140821f, -0.0624672f, -0.0118863f, 0.0972955f, -0.0409267f, -0.3631141f, 0.0599408f, -0.1372257f};
  assert_complex(expected, 20, output, output_len);
  free(input);
  // another 200 inputs
  setup_input_data(&input, 200, 200);
  process(input, input_len, &output, &output_len, filter);
  const float expectedNextBatch[] = {-0.0181596f, 0.0526057f, 0.0091469f, -0.0246920f, -0.0039109f, 0.0178462f, -0.0017804f, -0.0222949f, 0.0058664f, 0.0415433f, -0.0297081f, -0.1274426f, 0.0284960f, -0.1286570f, -0.0046520f, 0.0403289f, 0.0026808f, -0.0176709f, -0.0014942f, 0.0062975f, 0.0006636f,
                                     -0.0001986f, 0.0010920f, -0.0064977f, -0.0025695f, 0.0195067f, 0.0024404f, -0.0431467f, 0.0218642f, 0.1772941f, -0.0290195f, 0.0697242f, 0.0088646f, -0.0250897f, -0.0052992f, 0.0107063f, 0.0028312f, -0.0055495f, -0.0012581f, 0.0002499f};
