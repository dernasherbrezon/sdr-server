...
START_TEST (test_invalid_request) {
	...
	reconnect_client();
	send_message(PROTOCOL_VERSION, TYPE_REQUEST, 460700000, 47000, 460600000);
	assert_response(TYPE_RESPONSE, RESPONSE_STATUS_FAILURE, RESPONSE_DETAILS_INVALID_REQUEST);

	reconnect_client();
	send_message(PROTOCOL_VERSION, TYPE_REQUEST, 460700000, 4032000, 460600000);
	assert_response(TYPE_RESPONSE, RESPONSE_STATUS_FAILURE, RESPONSE_DETAILS_INVALID_REQUEST);

	reconnect_client();
	send_message(PROTOCOL_VERSION, TYPE_REQUEST, 462400000, 48000, 460600000);
	assert_response(TYPE_RESPONSE, RESPONSE_STATUS_FAILURE, RESPONSE_DETAILS_INVALID_REQUEST);

	reconnect_client();
	send_message(PROTOCOL_VERSION, TYPE_REQUEST, 458800000, 48000, 460600000);
	assert_response(TYPE_RESPONSE, RESPONSE_STATUS_FAILURE, RESPONSE_DETAILS_INVALID_REQUEST);
}
END_TEST
